...
export const VENUES: Record<string, VenueInfo> = {
  ...
  "raydium-cpmm": {
    ...
    programIdSource: "Raydium SDK v2 CPMM program; verify on an explorer",
    sdkPackage: "@raydium-io/raydium-sdk-v2",
    requiredFields: ["poolId", "lpTokens", "lpSupply", "reserveA", "reserveB", "tokenMintA", "tokenMintB"],
    limitations: ["full-range constant product; valued by share of pool, not by range"],
  },
  "meteora-damm-v2": {
    id: "meteora-damm-v2",
    ...
    discoveryStatus: "sdk_adapter",
    readOnly: true,
    programIdSource: "confirm the program id on an explorer before using the live path",
    sdkPackage: "@meteora-ag/cp-amm-sdk",
    requiredFields: ["pool", "lpTokens", "lpSupply", "reserveA", "reserveB", "tokenAMint", "tokenBMint"],
    limitations: ["full-range constant product; valued by share of pool. Verify the program id before the live path"],
  },
};
